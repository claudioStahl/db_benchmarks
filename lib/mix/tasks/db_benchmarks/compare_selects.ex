defmodule Mix.Tasks.DbBenchmarks.CompareSelects do
  ...
  defp exec(table, user_ids, level) do
    ...
    {from, to} =
      case level do
        "1" -> {~N[2022-11-30 00:00:00], ~N[2022-12-01 23:59:59]}
        "2" -> {~N[2022-12-02 00:00:00], ~N[2022-12-03 23:59:59]}
        "3" -> {~N[2022-12-15 00:00:00], ~N[2022-12-16 23:59:59]}
        "4" -> {~N[2022-12-28 00:00:00], ~N[2022-12-29 23:59:59]}
      end
